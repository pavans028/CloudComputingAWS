...
ubuntu@ip-172-31-2-233:~$ java SharedMemoryOneThread 10GBUnsorted 10GBSorted

*** Convert the output file into dos format to run the valsort

ubuntu@ip-172-31-2-233:~$ unix2dos 10GBSorted
unix2dos: converting file 10GBSorted to DOS format ...

*** Run the valsort on the output file

ubuntu@ip-172-31-2-233:~$ ./64/valsort 10GBSorted
Records: 100000000
...
*** Get the top 10 lines of sorted data

ubuntu@ip-172-31-2-233:~$ head 10 10GBSorted
...
*** Get the last 10 lines of sorted data
   
ubuntu@ip-172-31-2-233:~$ tail 10GBSorted
