...
int main ()
{
  ...
  cout << "****************   1 MB BLOCK SIZE    **************" << endl << endl;
  ...
  {    
    ...
    cout << "Throughput for sequential read+write = " << ((i*loop_count)/(total_duration*1024*1024)) << " mbps" << endl << endl;
  }
  ...
  {    
    ...
    cout << "Thread count #"<< i << endl;
    cout << "Latency:" << (total_duration*1000)/(loop_count/BUFFER_SIZE) << "msecs"<< endl;
    cout << "Throughput for random read+write = " << ((i*loop_count)/(total_duration*1024*1024)) << " mbps" << endl << endl;
  }  
